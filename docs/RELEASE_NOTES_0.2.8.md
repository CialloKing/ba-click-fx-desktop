...
- 通知区域菜单的暂停、恢复、主窗口同步、Host 断开置灰和原有菜单行为已经完成人工操作验收；SDK
  `10.0.19041.0`/`10.0.22621.0`/`10.0.26100.0` CI 均已通过。
- 发布标签固定在三档 SDK CI 全绿的精确提交；远端 Release 只包含上述 Full 四资产，并通过回下载
  SHA-256 复核。Slim 不生成或上传发布资产。
